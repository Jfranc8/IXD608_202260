...
<header class="navbar">
	...
	<div class="container">
		<div class="card soft">
			<h2>About Jessica's Indoor Houseplants</h2>

			<p>Jessica's Indoor Houseplants is here to help you strengthen yor relationship with plants. We believe everyone should live with a little bit more green and bring the outdoors into their home. Most importantly, we focus on bringing the plants to you!</p>
		</div>
	</div>
